...
**Final-Year Information Technology Student | Backend & Full-Stack Developer**  
📍 Brașov, Romania  

[![LinkedIn](https://img.shields.io/badge/LinkedIn-NikitaShimbatoru-0077B5?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/nikita-schimbatoru/)
...
Final-year Information Technology student at **Transilvania University of Brașov** (Faculty of IESC) with hands-on experience in backend and full-stack development, API design, and AI-driven automation. Proficient in **Python (Django)**, **React / React Native**, **C++**, and **PostgreSQL**. Passionate about building robust software solutions, learning modern technologies, and contributing to impactful engineering projects.

- 🎓 **Education:** B.Sc. in Information Technology, Faculty of IESC @ Transilvania University of Brașov (Final Year)
- 💼 **Experience:**
  - **Backend Developer (Erasmus Summer Practice)** @ *Proton Energy Solutions* (Jul. 2025 – Oct. 2025)
  - **AI Code Evaluation & Technical QA (Freelance)** (Nov. 2025 – Mar. 2026)
- 🌐 **Volunteering:** Contributing to developing and maintaining the official website ([atbbrasov.ro](https://atbbrasov.ro)) for the Association of Bessarabian Youth in Brașov.
- 🗣️ **Languages:** Romanian (Native), English (Proficiency — C1).

---

## 🛠️ Technical Skills

- **Languages:** Python, JavaScript, C++, C, C#, Java, SQL, HTML5 / CSS3, GLSL
- **Backend & APIs:** Django, Django REST Framework, RESTful APIs, Spring Boot, .NET
- **Frontend & Mobile:** React.js, React Native, Vite, Expo Go
- **Graphics & Systems:** Modern OpenGL (3.3+ Core), GLSL, GLFW, GLUT, CMake
- **Databases & Cloud/Tools:** PostgreSQL, SQLite, MySQL, Docker, Git, GitHub, Linux, Windows, Postman
